...
// // Helper data
// const registrarAddress = "0x49aE3cC2e3AA768B1e5654f5D3C6002144A59581";
...
// // Helper function to create register method arguments
...
// Function to register the Basename
export async function registerBasename(agentName: string, addressId: string) {
  try {
    const provider = new ethers.JsonRpcProvider("https://sepolia.base.org");
    const wallet = new ethers.Wallet(
      "0x534cd71ac1b6cec17f39ece502bc3f149246925ef46c4e6e12260a9959bab091",
      provider
    );
    ...
    console.log(`Basename ${agentName} registered successfully!`);
    console.log(`Transaction link: https://sepolia.basescan.org/tx/${tx.hash}`);
  } catch (error) {
...
//   const addressId = "0x914eEe7334f5Fb7cFcbf7e74A20E68B981aC8f8a";
//   await registerBasename(agentName, addressId);
// })();
